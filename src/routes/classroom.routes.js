...
router.post(
  "/class/:classCode/regenerate-invite",
  verifyClassroomOwner,
  regenerateInviteCode
);
...
router.post(
  "/class/:classCode/exams",
  verifyClassroomTeacher,
  checkClassroomActive,
  createExamForClassroom
);
router.get("/class/:classCode/exams", verifyClassroomAccess, getClassroomExams);
router.delete(
  "/class/:classCode/exams/:contestId",
  verifyClassroomTeacher,
  checkClassroomActive,
  deleteExamFromClassroom
);
...
router.patch(
  "/class/:classCode/problems/:problemShortId",
  verifyClassroomTeacher,
  checkClassroomActive,
  updateProblemInClassroom
);
...
router.get(
  "/class/:classCode/problems/with-progress",
  authenticateToken,
  verifyClassroomAccess,
  getClassroomProblemsWithProgress
);
...
router.delete(
  "/class/:classCode/students/:studentId",
  verifyClassroomTeacher,
  checkClassroomActive,
  removeStudent
);
router.get(
  "/class/:classCode/students/:studentId/progress",
  verifyClassroomTeacher,
  getStudentProgress
);
...
router.post(
  "/class/:classCode/upload-students-excel",
  verifyClassroomTeacher,
  checkClassroomActive,
  upload.single("file"),
  uploadStudentsExcel
...
router.post(
  "/class/:classCode/invite-by-email",
  verifyClassroomTeacher,
  checkClassroomActive,
  inviteStudentsByEmail
);
router.post(
  "/class/:classCode/create-accounts",
  verifyClassroomTeacher,
  checkClassroomActive,
  createStudentAccounts
);
...
router.get(
  "/class/:classCode/activities",
  verifyClassroomAccess,
  getRecentActivities
);

router.get(
  "/class/:classCode/discussions",
  verifyClassroomAccess,
  getDiscussions
);
...
router.get(
  "/class/:classCode/discussions/:discussionId",
  verifyClassroomAccess,
  getDiscussionById
);
...
// Comments
router.post(
  "/class/:classCode/discussions/:discussionId/comments",
  verifyClassroomAccess,
  checkClassroomActive,
  addComment
);
...
router.put(
  "/class/:classCode/discussions/:discussionId/comments/:commentId",
  verifyClassroomAccess,
  checkClassroomActive,
  editComment
);
...
router.post(
  "/class/:classCode/discussions/:discussionId/comments/:commentId/like",
  verifyClassroomAccess,
  toggleCommentLike
);
//Reply
router.post(
  "/class/:classCode/discussions/:discussionId/comments/:commentId/replies",
  verifyClassroomAccess,
  checkClassroomActive,
  addReply
);
...
router.put(
  "/class/:classCode/discussions/:discussionId/comments/:commentId/replies/:replyId",
  verifyClassroomAccess,
  checkClassroomActive,
  editReply
);
...
router.post(
  "/class/:classCode/discussions/:discussionId/comments/:commentId/replies/:replyId/like",
  verifyClassroomAccess,
  toggleReplyLike
);
...
// Reactions
router.post(
  "/class/:classCode/discussions/:discussionId/react",
  verifyClassroomAccess,
  addReaction
);
...
router.post(
  "/class/:classCode/discussions/:discussionId/pin",
  verifyClassroomTeacher,
  togglePin
);

router.post(
  "/class/:classCode/discussions/:discussionId/lock",
  verifyClassroomTeacher,
  toggleLock
);

router.post(
  "/class/:classCode/discussions/:discussionId/archive",
  verifyClassroomTeacher,
  archiveDiscussion
);
...
router.post("/class/:classCode/close", verifyClassroomOwner, closeClassroom);

// Lưu trữ lớp học (chỉ lớp đã đóng)
router.post(
  "/class/:classCode/archive",
  verifyClassroomOwner,
  archiveClassroom
);

// Mở lại lớp học (từ closed -> active)
router.post("/class/:classCode/reopen", verifyClassroomOwner, reopenClassroom);

// Khôi phục lớp học (từ archived -> closed)
router.post(
  "/class/:classCode/restore",
  verifyClassroomOwner,
  restoreClassroom
);

// Kiểm tra trạng thái và tự động đóng nếu hết hạn
router.get(
  "/class/:classCode/check-status",
  verifyClassroomAccess,
  checkClassroomStatus
);
